...
import unittest
from dns_shark.__main__ import main
...
class MainTests(unittest.TestCase):
    ...
    def test_main_format_error(self):
        """
        ...
        with redirect_stdout(self.buffer):
            main(mock_resolver, "www.cs.ubc.ca", "1.2.3.4", False, False)

        self.assertEqual(self.buffer.getvalue(), "\nFormat Error Message\n")

    def test_main_name_error(self):
        """
    ...
    def test_main_server_failure_error(self):
        """
    ...
    def test_main_refused_error(self):
        """
    ...
    def test_main_no_matching_resource_record_error(self):
        """
    ...
    def test_main_zero_counter_error(self):
        """
    ...
    def test_main_one_answer_returned(self):
        """
    ...
    def test_main_two_answers_returned(self):
        """
